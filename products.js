...
const products = [
    ...
    description: "Ergonomic adjustable desk designed for comfortable work and improved posture."
},
{
    id: 14,
    name: "Couch Large",
    price: 499.99,
    image: "images/extra/couch_large.png",
    category: "furniture",
    model: "Models/Products/extra/couch_large.glb",
    description: "Spacious and comfortable large couch, perfect for living rooms and family spaces."
},
{
    id: 15,
    name: "Couch Small",
    price: 299.99,
    image: "images/extra/couch_small.png",
    category: "furniture",
    model: "Models/Products/extra/couch_small.glb",
    description: "Compact sofa ideal for small apartments or cozy seating areas."
},
{
    id: 16,
    name: "Desk",
    price: 159.99,
    image: "images/extra/desk.png",
    category: "furniture",
    model: "Models/Products/extra/desk.glb",
    description: "Minimalist desk suitable for home offices, study rooms, or workspaces."
},
{
    id: 17,
    name: "L Couch",
    price: 549.99,
    image: "images/extra/l_couch.png",
    category: "furniture",
    model: "Models/Products/extra/l_couch.glb",
    description: "Modern L-shaped couch offering extra seating and comfort for larger spaces."
}
];
